// Importing necessary utilities and functions from Redux toolkit and other libraries
// Importing service layer for product-related operations
// Importing toast notifications
/**
 * Redux thunk for creating a new product.
 * It dispatches actions to handle the states of the asynchronous process.
 * On success, the product data is returned.
 * On error, the error message is returned using rejectWithValue.
 */
// Initial state for the product reducer
// Action type prefix for this thunk
// Payload creator and thunk API for middleware logic
...
// Initialize an array to store the value of each product.
// Mapping through and destucture each product to calculate its value (price * quantity)
